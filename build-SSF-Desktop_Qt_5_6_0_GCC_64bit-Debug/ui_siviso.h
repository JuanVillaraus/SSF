...
public:
    ...
    void setupUi(QMainWindow *siviso)
    {
        ...
        GPSOr = new QPushButton(Desptact);
        GPSOr->setObjectName(QStringLiteral("GPSOr"));
        GPSOr->setGeometry(QRect(290, 560, 71, 27));
        pulso = new QPushButton(Desptact);
        pulso->setObjectName(QStringLiteral("pulso"));
        pulso->setGeometry(QRect(370, 660, 71, 27));
        prog = new QPushButton(Desptact);
        prog->setObjectName(QStringLiteral("prog"));
        prog->setGeometry(QRect(700, 610, 71, 27));
        autoSend = new QPushButton(Desptact);
        autoSend->setObjectName(QStringLiteral("autoSend"));
        autoSend->setGeometry(QRect(370, 630, 101, 27));
        btLF = new QPushButton(Desptact);
        btLF->setObjectName(QStringLiteral("btLF"));
        btLF->setGeometry(QRect(450, 660, 61, 27));
        Uu = new QSpinBox(Desptact);
        Uu->setObjectName(QStringLiteral("Uu"));
        Uu->setGeometry(QRect(630, 580, 61, 41));
        Uu->setMinimum(2);
        Uu->setMaximum(1022);
        Uu->setValue(2);
        Ud = new QSpinBox(Desptact);
        Ud->setObjectName(QStringLiteral("Ud"));
        Ud->setGeometry(QRect(630, 640, 61, 41));
        Ud->setMinimum(1);
        Ud->setMaximum(1023);
        Ud->setValue(1);
        label_70 = new QLabel(Desptact);
        label_70->setObjectName(QStringLiteral("label_70"));
        label_70->setGeometry(QRect(640, 620, 41, 17));
...
"Verdadero", 0));
        ...
        btLF->setText(QApplication::translate("siviso", "lofar", 0));
